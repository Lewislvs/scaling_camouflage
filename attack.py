...
import argparse
import time
from area_scale_integerborders import area_scale_attack_integerborders
from AreaNormEnumType import AreaNormEnumType
...
if __name__ == '__main__':
    ...
    targetImg = cv2.resize(targetImg, (32,24))
    ...
    # attackImg = area_scale_attack_integerborders(
    #     tar_image=targetImg, src_img=sourceImg,
    #     eps=3, blockwise=True, verbose=False, attack_norm=AreaNormEnumType.L1)
    attackImg = sc.attack()
